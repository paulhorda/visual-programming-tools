...
public class ImageEdit
{
    ...
    public ImageEdit()
    {
        ...
        JButton penbutton = new  JButton(new  ImageIcon("src/pen.png"));
        ...
        JButton brushbutton = new  JButton(new  ImageIcon("src/brush.png"));
        ...
        JButton lasticbutton = new JButton(new  ImageIcon("src/lastic.png"));
        ...
        JButton textbutton = new  JButton(new  ImageIcon("src/text.png"));
        ...
        JButton linebutton = new  JButton(new  ImageIcon("src/line.png"));
        ...
        JButton elipsbutton = new  JButton(new  ImageIcon("src/elips.png"));
        ...
        JButton rectbutton = new  JButton(new  ImageIcon("src/rect.png"));
        ...
        JButton roundrectbutton = new  JButton(new  ImageIcon("src/rect_round.png"));
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                switch(rezhim)
                {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        g.drawRoundRect(x1, y1, (x2-x1), (y2-y1), 16, 16);
                        break;
                }
                xf=0; yf=0;
                pressed=false;
        ...
        f.addComponentListener(new  ComponentAdapter() {
            public void componentResized(java.awt.event.ComponentEvent evt) {
                ...
                if(loading==false)
                {
                    ...
                    tempImage.setData(tempImage.getRaster());
                    imag=tempImage;
                    japan.repaint();
                }
                loading=false;
